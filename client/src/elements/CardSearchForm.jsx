...
const CardSearchForm = ({ setSearchResults, setSearchWasSuccessful, setDataIsLoading }) => {
    //hooks
                        ...
                        for (let i = 0; i < data.length; i++) {
                            ...
                            if (data[i].card_faces) {
                                ...
                                if (data[i].card_faces[0].image_uris) {
                                    if (data[i].card_faces[0].image_uris.png) {
                                        img = data[i].card_faces[0].image_uris.png;
                                    } else if (data[i].card_faces[0].image_uris.small) {
                                ...
                                card[i] = {
                                    ...
                                    img_url: img,
                                    card_art: data[i].card_faces[0].image_uris.art_crop,
                                ...
                                card[i] = {
                                    ...
                                    name: data[i].name,
                                    color: data[i].colors,
                                    img_url: data[i].image_uris.png,
                                    card_art: data[i].image_uris.art_crop,
                                    CMC: data[i].cmc,
